        ...
        <div class="slide-container">
            <div id="welcome-slide">
                ...
                <div class="slide-content" style="text-align: center;">
                    <br>
                    <span style="font-weight: bold; font-size: 50px; background: #ffffff; margin-top:0; padding: 0px 50px; border: solid #000000 2px;">WELCOME</span>
                    <p style="margin-top: 4px;">CJ BRASSINGTON FULL STACK DEVELOPER</p>
                </div>
            </div>
        </div>
    </div>
